...
public final class MySQLDatabase extends Database<Connection> {
  ...
  private static final String CONNECT_ARGUMENTS =
      "jdbc:mysql://{0}:{1}/{2}?autoReconnect=true&useUnicode=true&useJDBCCompliantTimezoneShift=true"
  ...
  public MySQLDatabase() {
    ...
    URL dependency = DEPENDENCY_LOADER.loadDependency(
        new DefaultDependency(DefaultRepositories.MAVEN_CENTRAL, "mysql",
    ...
    if (!isConnected()) {
      ...
      try {
        ...
        this.connection = DriverManager.getConnection(
            MessageFormat.format(CONNECT_ARGUMENTS, host,
  ...
  private void startReconnect() {
    TaskScheduler.INSTANCE.schedule(
        () -> createDatabase("internal_users"), 0, 5, TimeUnit.MINUTES);
  }
}
