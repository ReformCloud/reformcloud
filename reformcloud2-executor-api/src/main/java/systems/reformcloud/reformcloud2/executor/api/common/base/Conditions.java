...
public final class Conditions {
   ...
   * @param message The message which will be printed if the argument is {@code
   *     false}
   */
   ...
   * @param test The argument which should be checked
   */
  public static void isTrue(boolean test) { isTrue(test, null); }
   ...
   */
  public static void isTrue(boolean test, @Nonnull String message,
   ...
   */
  public static void nonNull(@Nullable Object obj) { nonNull(obj, null); }
