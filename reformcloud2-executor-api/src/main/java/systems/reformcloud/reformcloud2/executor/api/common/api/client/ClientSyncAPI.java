...
public interface ClientSyncAPI {
     ...
     *
     * @param name The name of the client
     * @return The start host of the client or {@code null} if the client is not connected
     */
    @Nullable
    String getClientStartHost(@Nonnull String name);

    /**
     * Gets the maximal memory memory of a client
     *
     * @param name The name of the client
     * @return The maximal memory of the client or {@code -1} if the client is not connected
     */
     ...
     *
     * @param name The name of the client
     * @return The max processes of the client or {@code -1} if the client is not connected
     */
     ...
     *
     * @param name The name of the client
     * @return The client runtime info or {@code null} if the client is not connected
     */
    @Nullable
    ClientRuntimeInformation getClientInformation(@Nonnull String name);
}
