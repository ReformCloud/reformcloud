...
public final class DownloadHelper {
  ...
  private DownloadHelper() { throw new UnsupportedOperationException(); }
  ...
  public static void downloadAndDisconnect(String url, String target) {
    openConnection(url, stream -> {
      ...
      SystemHelper.doCopy(stream, Paths.get(target),
                          StandardCopyOption.REPLACE_EXISTING);
    });
  }

  public static void openConnection(String url, Map<String, String> headers,
