...
public interface GroupAsyncAPI {
   ...
   * @return A task which will be completed with the new main group after the
   *     update
   */
  @Nonnull
  @CheckReturnValue
   ...
   * @return A task which will be completed with the process group after the
   *     update
   */
  @Nonnull
  @CheckReturnValue
   ...
   * @return A task which will be completed with the main group or {@code null}
   ...
   * @return A task which will be completed with the process group or {@code
   *     null} if the process group does not exists
   */
  @Nonnull
  @CheckReturnValue
   ...
   * @return A task which will be completed after the successful delete of the
   *     group
   */
  @Nonnull
  @CheckReturnValue
   ...
   */
  @Nonnull @CheckReturnValue Task<List<MainGroup>> getMainGroupsAsync();
   ...
   */
  @Nonnull @CheckReturnValue Task<List<ProcessGroup>> getProcessGroupsAsync();
}
