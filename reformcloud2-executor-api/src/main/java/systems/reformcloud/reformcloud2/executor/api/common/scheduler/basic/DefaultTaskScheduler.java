...
public final class DefaultTaskScheduler implements TaskScheduler {
  ...
  @Nonnull
  @Override
  public ScheduledTask schedule(@Nonnull Runnable runnable, long delay,
  ...
  @Override
  public ScheduledTask schedule(@Nonnull Runnable runnable, long delay,
                                long period, @Nonnull TimeUnit timeUnit) {
    ScheduledTask scheduledTask = new DefaultTask(
        atomicInteger.getAndIncrement(), runnable, delay, period, timeUnit);
    synchronized (object) { tasks.put(scheduledTask.getID(), scheduledTask); }
