...
public interface DatabaseAsyncAPI {
   ...
   * @return A task which will be completed with a json config or {@code null}
   *     if the entry does not exists
   */
  @Nonnull
  @CheckReturnValue
  Task<JsonConfiguration> findAsync(@Nonnull String table, @Nonnull String key,
  ...
  @Nonnull
  @CheckReturnValue
  <T> Task<T> findAsync(@Nonnull String table, @Nonnull String key,
                        @Nullable String identifier,
  ...
  @Nonnull
  @CheckReturnValue
  Task<Void> insertAsync(@Nonnull String table, @Nonnull String key,
                         @Nullable String identifier,
   ...
   * @return A task which will be completed with {@code true} if the config got
   *     updated or {@code false}
   */
  @Nonnull
  @CheckReturnValue
  Task<Boolean> updateAsync(@Nonnull String table, @Nonnull String key,
  ...
  @Nonnull
  @CheckReturnValue
  Task<Boolean> updateIfAbsentAsync(@Nonnull String table,
  ...
  @Nonnull
  @CheckReturnValue
  Task<Void> removeIfAbsentAsync(@Nonnull String table,
                                 @Nonnull String identifier);
   ...
   * @return A task which will be completed with {@code true} if the operation
   *     was successful else {@code false}
   */
  @Nonnull
  @CheckReturnValue
   ...
   * @param key The key of the entry
   * @return A task which will be completed with {@code true} if the value is
   *     present else {@code false}
   */
  @Nonnull
  @CheckReturnValue
   ...
   * @return A task which will be completed with the current size of the
   *     database
   */
  @Nonnull @CheckReturnValue Task<Integer> sizeAsync(@Nonnull String table);
}
