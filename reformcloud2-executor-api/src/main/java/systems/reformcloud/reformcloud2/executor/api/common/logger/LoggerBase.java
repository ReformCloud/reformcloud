...
public abstract class LoggerBase extends Logger implements AutoCloseable {
  ...
  public LoggerBase() { super("ReformCloudBaseLogger", null); }

  /**
   * @return The current console reader of the cloud
   */
  @Nonnull public abstract ConsoleReader getConsoleReader();
   ...
   */
  @Nonnull public abstract String readLine();

  /**
   * @see #readLine()
   * @return Reads the current line without a prompt
   */
  @Nonnull public abstract String readLineNoPrompt();

  /**
   * Reads the console input and waits for the correct input
   *
   * @param predicate The predicate which should check if the console input is
   *     correct
   * @param invalidInputMessage The runnable if the input is invalid it get
   *     called
   * @return The string which was given in the console
   */
  @Nonnull
  public abstract String readString(@Nonnull Predicate<String> predicate,
                                    @Nonnull Runnable invalidInputMessage);

  /**
   * Reads the console input and waits for the correct input
   *
   * @param function The function which handles the console input and converts
   *     it into the needed object
   * @param invalidInputMessage The runnable if the input is invalid it get
   *     called
  ...
  @Nonnull
  @CheckReturnValue
  public abstract <T> T read(@Nonnull Function<String, T> function,
                             @Nonnull Runnable invalidInputMessage);
  ...
  /**
   * Logs a message to the console, also available with {@link System#out};
   * This replaces all colour codes in the message before printing it into the
   * console
   *
   * @param message The message which should be logged into the console
   */
   ...
   */
  @Nonnull
  public abstract LoggerBase
  addLogLineHandler(@Nonnull LoggerLineHandler handler);
   ...
   */
  @Nonnull public abstract Debugger getDebugger();
}
