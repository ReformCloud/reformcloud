...
public interface GroupSyncAPI {
   ...
   */
  @Nonnull MainGroup createMainGroup(@Nonnull String name);
   ...
   */
  @Nonnull ProcessGroup createProcessGroup(@Nonnull String name);
   ...
   * @param templates The templates which should be used for the new group
   * @param startupConfiguration The startup config of the new process group
   * @param playerAccessConfiguration The new player access configuration of the
   *     process group
   * @return The created process group
   */
  @Nonnull
   ...
   * @return The created process group
   */
  @Nonnull ProcessGroup createProcessGroup(@Nonnull ProcessGroup processGroup);
   ...
   */
  @Nonnull MainGroup updateMainGroup(@Nonnull MainGroup mainGroup);
   ...
   */
  @Nonnull ProcessGroup updateProcessGroup(@Nonnull ProcessGroup processGroup);
   ...
   */
  @Nullable MainGroup getMainGroup(@Nonnull String name);

  /**
   * Get a process group
   *
   * @param name The name of the process group which should be found
   * @return The process group or {@code null} if the process group does not
   *     exists
   */
  @Nullable ProcessGroup getProcessGroup(@Nonnull String name);
   ...
   */
  @Nonnull List<MainGroup> getMainGroups();
   ...
   */
  @Nonnull List<ProcessGroup> getProcessGroups();
