...
public interface ProcessManager
    extends Iterable<ProcessInformation>, Updateable<ProcessInformation> {
   ...
   * @return A list which contains all process information about the running
   *     process
   ...
   * <p>
   * @param group The name of the group which should be filtered (required to be
   *     non-null)
   ...
   * @return The filtered process information or {@code null} if the process
   *     does not exists
   * @see ProcessInformation
   * @see #getProcess(UUID)
   */
  @Nullable ProcessInformation getProcess(String name);

  /**
   * Gets a specific process by the process uniqueID
   * <p>
   * @param uniqueID The unique id of the process
   * @return The current process information or {@code null} if the process does
   *     not exists
   * @see ProcessInformation
   * @see #getProcess(String)
   */
  @Nullable ProcessInformation getProcess(UUID uniqueID);

  /**
   * Starts a process of the specified group and filters automatically the best
   * template <p>
   ...
   */
  @Nullable ProcessInformation startProcess(String groupName);

  /**
   * Starts a process with the given template name
   * <p>
   * @param groupName The name if tge group which is required to be non-null
   * @param template The name of the template which must not exists using
   *     default template instead
   * @return The process information of the created process
   * @see ProcessInformation
   * @see #startProcess(String, String, JsonConfiguration)
   */
  @Nullable ProcessInformation startProcess(String groupName, String template);

  /**
   * Starts a process with the given template name and the json configuration as
   * extra data for the process object <p>
   * @param groupName The name if tge group which is required to be non-null
   * @param template The name of the template which must not exists using
   *     default template instead
   * @param configurable The extra data which you can read on the process (can
   *     be {@code null})
   * @return The process information of the created process
   * @see ProcessInformation
   */
   ...
   * <p>
   * @param name The name of the running process which is required to be
   *     non-null
   * @return The last known process information or {@code null} if the process
   *     is unknown
   * @see ProcessInformation
   * @see #stopProcess(UUID)
   */
  @Nullable ProcessInformation stopProcess(String name);
   ...
   */
  @Nullable ProcessInformation stopProcess(UUID uniqueID);

  /**
   * This method will be called when a client disconnects, to remove all running
   * processes and let the cloud move them to the next client <p>
   ...
   * <p>
   * @param uniqueID The uniqueID of the process information which will be used
