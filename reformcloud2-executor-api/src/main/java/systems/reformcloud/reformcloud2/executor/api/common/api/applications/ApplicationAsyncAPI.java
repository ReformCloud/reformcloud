...
public interface ApplicationAsyncAPI {
   ...
   * @return A task which will be completed with the loaded application or
   *     {@code null} if the app is unloaded
   */
  @Nonnull
  @CheckReturnValue
   ...
   *
   * @return A task which will be completed with a list of all known and loaded
   *     application
   */
  @Nonnull
  @CheckReturnValue
