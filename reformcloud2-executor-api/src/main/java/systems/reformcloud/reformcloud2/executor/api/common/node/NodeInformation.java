...
public class NodeInformation {
  ...
  public static final TypeToken<NodeInformation> TYPE =
      new TypeToken<NodeInformation>() {};
  ...
  public NodeInformation(String name, UUID nodeUniqueID, long startupTime,
                         ...
                         Collection<NodeProcess> startedProcesses) {
    this.name = name;
  ...
  public void addUsedMemory(int memory) { this.usedMemory += memory; }

  public void removeUsedMemory(int memory) { this.usedMemory -= memory; }
