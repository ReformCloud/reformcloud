...
public class InternalJsonParser {
  ...
  private InternalJsonParser() { throw new UnsupportedOperationException(); }
  ...
  @Nonnull
  private static JsonElement parseReader(JsonReader reader)
    ...
    try {
      ...
      throw new JsonParseException(
          "Failed parsing JSON source: " + reader + " to Json", ex);
    } finally {
