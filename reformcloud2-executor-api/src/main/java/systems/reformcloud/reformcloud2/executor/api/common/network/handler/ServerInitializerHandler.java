...
public final class ServerInitializerHandler extends InitializerHandler {
  ...
  public ServerInitializerHandler(
      PacketHandler packetHandler, Consumer<PacketSender> consumer,
      DoubleFunction<Packet, String, Boolean> function,
      BiFunction<String, ChannelHandlerContext, PacketSender> onAuthSuccess,
  ...
  private final BiFunction<String, ChannelHandlerContext, PacketSender>
      onSuccess;
  ...
  protected void initChannel(Channel channel) {
    channel.pipeline()
        ...
        .addLast("handler", new ChannelReaderHelper(newHandler(), function,
                                                    onSuccess, onAuthFailure));
  }
}
