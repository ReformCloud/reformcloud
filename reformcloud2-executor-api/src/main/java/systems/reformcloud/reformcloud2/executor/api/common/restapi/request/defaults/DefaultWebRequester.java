...
public class DefaultWebRequester implements WebRequester {
  ...
  public DefaultWebRequester(ChannelHandlerContext context, String name,
  ...
  public PermissionResult hasPermissionValue(@Nonnull String perm) {
    ...
    return matched == null ? PermissionResult.NOT_SET
                           : matched.startsWith("-") ? PermissionResult.DENIED
