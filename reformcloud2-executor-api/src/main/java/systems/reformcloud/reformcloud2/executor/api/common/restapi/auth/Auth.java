...
public interface Auth {
   ...
   *
   * @param configurable The configurable which got parsed by the incoming http
   *     request
   * @param channelHandlerContext The channel context of the incoming request
   * @return A double with the key value {@code true} if the auth was successful
   *     and as value the {@link WebRequester} if the auth was successful
   */
  @Nonnull
  Double<Boolean, WebRequester>
