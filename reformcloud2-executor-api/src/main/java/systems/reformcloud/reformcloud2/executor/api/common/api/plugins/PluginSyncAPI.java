...
public interface PluginSyncAPI {
   ...
   */
  void installPlugin(@Nonnull String process,
   ...
   * @param plugin The plugin which should be installed
   */
  void installPlugin(@Nonnull ProcessInformation process,
                     @Nonnull InstallablePlugin plugin);
   ...
   * @param plugin The plugin which should be unloaded
   */
  void unloadPlugin(@Nonnull ProcessInformation process,
   ...
   * @return The installed plugin or {@code null} if the process is not
   *     installed
   */
  @Nullable
   ...
   */
  @Nullable
  Plugin getInstalledPlugin(@Nonnull ProcessInformation process,
                            @Nonnull String name);
   ...
   */
  @Nonnull
  Collection<DefaultPlugin> getPlugins(@Nonnull ProcessInformation process,
                                       @Nonnull String author);
   ...
   */
  @Nonnull Collection<DefaultPlugin> getPlugins(@Nonnull String process);
