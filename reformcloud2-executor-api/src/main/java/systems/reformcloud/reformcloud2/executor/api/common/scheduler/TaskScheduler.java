...
public interface TaskScheduler {
  ...
  @Nonnull TaskScheduler INSTANCE = new DefaultTaskScheduler();
   ...
   */
  @Nonnull ScheduledTask runAsync(@Nonnull Runnable runnable);
   ...
   */
  @Nonnull
  ScheduledTask schedule(@Nonnull Runnable runnable, long delay,
   ...
   */
  @Nonnull
  ScheduledTask schedule(@Nonnull Runnable runnable, long delay, long period,
                         @Nonnull TimeUnit timeUnit);
}
