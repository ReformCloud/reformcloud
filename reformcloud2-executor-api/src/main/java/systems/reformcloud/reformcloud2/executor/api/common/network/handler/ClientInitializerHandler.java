...
public final class ClientInitializerHandler extends InitializerHandler {
  ...
  private static final DoubleFunction<Packet, String, Boolean> EMPTY_FUNCTION =
      packet -> {
  ...
  public ClientInitializerHandler(NetworkChannelReader channelReader,
  ...
  protected void initChannel(Channel channel) {
    channel.pipeline()
        ...
        .addLast("handler",
                 new ChannelReaderHelper(channelReader, EMPTY_FUNCTION,
