...
public enum Version {
  ...
  PAPER_1_9_4("Paper 1.9.4", "1.9.4",
              "https://dl.reformcloud.systems/mcversions/paper/paper-1.9.4.jar",
              1),
  PAPER_1_10_2(
      "Paper 1.10.2", "1.10.2",
  ...
  PAPER_1_15("Paper 1.15", "1.15",
             "https://dl.reformcloud.systems/mcversions/paper/paper-1.15.jar",
             1),
  ...
  HOSE_1_11_2("Hose 1.11.2", "1.11.2",
              "https://dl.reformcloud.systems/mcversions/hose/hose-1.11.2.jar",
              1),
  /**
   * Glowstone Versions
   */
  GLOWSTONE_1_10_2(
      "Glowstone 1.10_2", "1.10.2",
      "https://dl.reformcloud.systems/mcversions/glowstone/glowstone-1.10.2.jar",
      1),
  GLOWSTONE_1_12_2(
      "Glowstone 1.12.2", "1.12.2",
      "https://dl.reformcloud.systems/mcversions/glowstone/glowstone-1.12.2.jar",
      1),
  /**
   * Akarin Versions
   */
  AKARIN_1_12_2(
      "Akarin 1.12.2", "1.12.2",
  ...
  NUKKIT_X(
      "NukkitX", "1.0",
      "https://ci.nukkitx.com/job/NukkitX/job/Nukkit/job/master/lastStableBuild/artifact/target/nukkit-1.0-SNAPSHOT.jar",
      3),
  /**
  ...
  WATERDOG(
      "Waterdog", "1.8-1.14",
      "https://ci.codemc.org/job/yesdog/job/Waterdog/lastSuccessfulBuild/artifact/Waterfall-Proxy/bootstrap/target/Waterdog.jar",
      2),
  /**
  ...
  private static final TreeMap<String, Version> JAVA_SERVER_PROVIDERS =
      new TreeMap<>();

  private static final TreeMap<String, Version> JAVA_PROXY_PROVIDERS =
      new TreeMap<>();

  private static final TreeMap<String, Version> POCKET_SERVER_PROVIDERS =
      new TreeMap<>();

  private static final TreeMap<String, Version> POCKET_PROXY_PROVIDERS =
      new TreeMap<>();
    ...
    for (Version version : values()) {
      if (version.id == 1 && !JAVA_SERVER_PROVIDERS.containsKey(version.name)) {
        JAVA_SERVER_PROVIDERS.put(version.name, version);
                 ...
                 !JAVA_PROXY_PROVIDERS.containsKey(version.name)) {
        JAVA_PROXY_PROVIDERS.put(version.name, version);
      } else if (version.id == 3 &&
                 !POCKET_SERVER_PROVIDERS.containsKey(version.name)) {
        POCKET_SERVER_PROVIDERS.put(version.name, version);
      } else if (version.id == 4 &&
                 !POCKET_PROXY_PROVIDERS.containsKey(version.name)) {
  ...
  public boolean isServer() { return getId() == 1 || getId() == 3; }

  public static void downloadVersion(Version version) {
    DownloadHelper.downloadAndDisconnect(version.url, "reformcloud/files/" +
                                                          format(version));
  }
