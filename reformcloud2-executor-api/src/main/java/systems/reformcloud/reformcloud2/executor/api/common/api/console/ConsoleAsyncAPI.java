...
public interface ConsoleAsyncAPI {
   ...
   * @return A task which will be completed if the action is completed (always
   *     {@code null})
   ...
   *     {@code null})
   */
  @Nonnull @CheckReturnValue Task<Void> sendRawLineAsync(@Nonnull String line);

  /**
   * Dispatches a command into the console and waits for a result
   *
   * @param commandLine The command line which should be executed
   * @return A task which will be completed with the result of the command or
   *     {@code null} if the command is
   *  a) not registered
   ...
   * @return A task which will be completed with the command or {@code null} if
   ...
   *
   * @param name The name of the command
   * @return A task which will be completed with {@code true} if the command is
   *     registered or else {@code false}
   */
  @Nonnull
  @CheckReturnValue
