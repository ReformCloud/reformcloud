...
public class Application {
  ...
  public final void init(@Nonnull LoadedApplication application,
                         AppClassLoader loader) {
    this.application = application;
    this.executorService = Executors.newCachedThreadPool(
        new ApplicationThreadFactory(new ApplicationThreadGroup(application)));
  ...
  public final void registerLanguage(Properties properties) {
    Language language =
        new ApplicationLanguage(application.getName(), properties);
  ...
  public final AppClassLoader getAppClassLoader() { return appClassLoader; }
  ...
  public void log(String log) { System.out.println(log); }
