...
public final class StartupConfiguration {
  ...
  public StartupConfiguration(int maxOnlineProcesses, int minOnlineProcesses,
                              int startupPriority, int startPort,
                              StartupEnvironment startupEnvironment,
                              boolean searchBestClientAlone,
                              List<String> useOnlyTheseClients) {
    this(maxOnlineProcesses, minOnlineProcesses, startupPriority, startPort,
         startupEnvironment, AutomaticStartupConfiguration.defaults(),
         searchBestClientAlone, useOnlyTheseClients);
  }

  public StartupConfiguration(
      int maxOnlineProcesses, int minOnlineProcesses, int startupPriority,
  ...
  public int getMaxOnlineProcesses() { return maxOnlineProcesses; }

  public int getMinOnlineProcesses() { return minOnlineProcesses; }

  public int getStartupPriority() { return startupPriority; }
  ...
  public boolean isSearchBestClientAlone() { return searchBestClientAlone; }
