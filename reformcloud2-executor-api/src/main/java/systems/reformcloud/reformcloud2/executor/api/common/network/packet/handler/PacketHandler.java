...
public interface PacketHandler {
   ...
   * Registers a packet handler
   *
   * @param networkHandler The class of the packet handler which should get
   *     registered
   */
   ...
   */
  @Nonnull List<NetworkHandler> getNetworkHandlers(int id);

  /**
   * @return All registered network handlers
   */
  @Nonnull List<NetworkHandler> getAllNetworkHandlers();

  /**
   * @return The query handler of the current instance
   */
  @Nonnull QueryHandler getQueryHandler();
