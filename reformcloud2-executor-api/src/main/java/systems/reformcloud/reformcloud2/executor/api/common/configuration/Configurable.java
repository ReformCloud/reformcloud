...
public interface Configurable<V extends Configurable> {
  ...
  @Nonnull V add(@Nonnull String key, @Nullable V value);

  @Nonnull V add(@Nonnull String key, @Nullable Object value);

  @Nonnull V add(@Nonnull String key, @Nullable String value);

  @Nonnull V add(@Nonnull String key, @Nullable Integer value);

  @Nonnull V add(@Nonnull String key, @Nullable Long value);

  @Nonnull V add(@Nonnull String key, @Nullable Short value);

  @Nonnull V add(@Nonnull String key, @Nullable Byte value);

  @Nonnull V add(@Nonnull String key, @Nullable Boolean value);

  @Nonnull V add(@Nonnull String key, @Nullable Double value);

  @Nonnull V add(@Nonnull String key, @Nullable Float value);

  @Nonnull V remove(@Nonnull String key);

  @Nonnull V get(@Nonnull String key);

  @Nullable<T> T get(@Nonnull String key, @Nonnull TypeToken<T> type);

  @Nullable<T> T get(@Nonnull String key, @Nonnull Class<T> type);

  @Nonnull @CheckReturnValue String getString(@Nonnull String key);

  @Nonnull @CheckReturnValue Integer getInteger(String key);

  @Nonnull @CheckReturnValue Long getLong(String key);

  @Nonnull @CheckReturnValue Short getShort(String key);

  @Nonnull @CheckReturnValue Byte getByte(String key);

  @Nonnull @CheckReturnValue Boolean getBoolean(String key);

  @Nonnull @CheckReturnValue Double getDouble(String key);

  @Nonnull @CheckReturnValue Float getFloat(String key);
  ...
  <T> T getOrDefaultIf(String key, Class<T> type, T def,
