...
public interface PlayerAsyncAPI {
   ...
   * @return A task which will be completed after the completion of the packet
   *     sent
   */
  @Nonnull
  @CheckReturnValue
  ...
  @Nonnull
  @CheckReturnValue
  Task<Void> kickPlayerFromServerAsync(@Nonnull UUID player,
  ...
  @Nonnull
  @CheckReturnValue
  Task<Void> playSoundAsync(@Nonnull UUID player, @Nonnull String sound,
                            float f1, float f2);
  ...
  @Nonnull
  @CheckReturnValue
  Task<Void> sendTitleAsync(@Nonnull UUID player, @Nonnull String title,
  ...
  @Nonnull
  @CheckReturnValue
  Task<Void> playEffectAsync(@Nonnull UUID player,
  ...
  @Nonnull
  @CheckReturnValue
  <T> Task<Void> playEffectAsync(@Nonnull UUID player, @Nonnull String effect,
                                 @Nullable T data);
   ...
   *     sent
   */
  @Nonnull @CheckReturnValue Task<Void> respawnAsync(@Nonnull UUID player);
  ...
  @Nonnull
  @CheckReturnValue
  Task<Void> teleportAsync(@Nonnull UUID player, @Nonnull String world,
  ...
  @Nonnull
  @CheckReturnValue
  Task<Void> connectAsync(@Nonnull UUID player,
