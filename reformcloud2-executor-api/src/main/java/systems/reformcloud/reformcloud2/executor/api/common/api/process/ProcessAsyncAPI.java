...
public interface ProcessAsyncAPI {
   ...
   * @return A task which which will be completed with the created {@link
   *     ProcessInformation}
   */
  @Nonnull
  @CheckReturnValue
  ...
  @Nonnull
  @CheckReturnValue
  Task<ProcessInformation>
  startProcessAsync(@Nonnull String groupName, @Nullable String template,
   ...
   * @return A task which will be completed with the last {@link
   *     ProcessInformation}
   */
  @Nonnull
  @CheckReturnValue
   ...
   *
   * @param name The name of the process
   * @return A task which will be completed with the {@link ProcessInformation}
   *     of the process or {@code null} if the process does not exists
   */
  @Nonnull
  @CheckReturnValue
  ...
  @Nonnull
  @CheckReturnValue
  Task<Void> executeProcessCommandAsync(@Nonnull String name,
   ...
   *
   * @return A task with will be completed with the current {@link
   *     ProcessInformation} or {@code null} if the runtime is not a process
   */
  @Nullable
  @CheckReturnValue
