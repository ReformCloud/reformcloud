...
public abstract class ExecutorAPI {
   ...
   * <br>
   * This action can only performed once on the current instance, normally by
   * the cloud itself
   *
   * @param instance The new instance of the executor api
   */
  protected static void setInstance(@Nonnull ExecutorAPI instance) {
    Conditions.isTrue(ExecutorAPI.instance == null,
                      "Executor api instance is already defined");
   ...
   */
  @Nonnull public abstract SyncAPI getSyncAPI();

  /**
   * @return The current async api instance
   */
  @Nonnull public abstract AsyncAPI getAsyncAPI();
   ...
   */
  @Nonnull public abstract PacketHandler getPacketHandler();

  /**
   * @return The current event manger of the cloud
   */
  @Nonnull public abstract EventManager getEventManager();
