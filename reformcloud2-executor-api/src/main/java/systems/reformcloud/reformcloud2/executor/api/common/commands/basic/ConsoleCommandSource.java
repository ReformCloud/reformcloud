...
public final class ConsoleCommandSource implements CommandSource {
  ...
  private static final PermissionCheck CONSOLE_COMMAND_CHECK =
      new ConsoleCommandCheck();

  private static final Collection<Permission> PERMISSIONS =
      Collections.singletonList(new Permission() {
        @Nonnull
        @Override
