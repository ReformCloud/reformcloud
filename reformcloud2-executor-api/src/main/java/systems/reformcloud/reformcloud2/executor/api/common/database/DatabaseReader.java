...
public interface DatabaseReader extends Iterable<JsonConfiguration>, Nameable {
   ...
   * @return A task which will be completed with the {@link JsonConfiguration}
   *     or {@code null} if the database does not contains the key
   */
  @Nonnull @CheckReturnValue Task<JsonConfiguration> find(@Nonnull String key);
   ...
   * @return A task which will be completed with the {@link JsonConfiguration}
   *     or {@code null} if the database does not contains the id
   */
  @Nonnull
  @CheckReturnValue
  ...
  @Nonnull
  @CheckReturnValue
  Task<JsonConfiguration> insert(@Nonnull String key,
  ...
  @Nonnull
  @CheckReturnValue
  Task<Boolean> updateIfAbsent(@Nonnull String identifier,
   ...
   */
  @Nonnull @CheckReturnValue Task<Void> remove(@Nonnull String key);
   ...
   * @return A task which will be completed with {@code true} if the database
   *     contains the document else {@code false}
   */
  @Nonnull @CheckReturnValue Task<Boolean> contains(@Nonnull String key);

  /**
   * @return A task which will be completed with the size of the current
   *     database
   */
  @Nonnull @CheckReturnValue Task<Integer> size();
}
