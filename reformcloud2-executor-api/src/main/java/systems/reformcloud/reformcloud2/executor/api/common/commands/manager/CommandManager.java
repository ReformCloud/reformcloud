...
public interface CommandManager extends CommandMap {
   ...
   */
  @Nonnull CommandManager register(@Nonnull Command command);

  /**
   * Registers a command
   *
   * @param command The command-class which should be instantiated and then
   *     registered
   * @return The current instance of the command manager
   */
  @Nonnull CommandManager register(@Nonnull Class<? extends Command> command);
   ...
   */
  @Nullable Command unregisterAndGetCommand(@Nonnull String command);

  /**
   * @return All registered commands
   */
  @Nonnull List<Command> getCommands();
}
