...
public abstract class Database<V> {
  ...
  protected static final DependencyLoader DEPENDENCY_LOADER =
   ...
   */
  public abstract void connect(@Nonnull String host, int port,
   ...
   */
  @Nullable @CheckReturnValue public abstract V get();
}
