...
public final class DefaultRequestListenerHandler
    implements RequestListenerHandler {

  public DefaultRequestListenerHandler(Auth auth) { this.auth = auth; }
