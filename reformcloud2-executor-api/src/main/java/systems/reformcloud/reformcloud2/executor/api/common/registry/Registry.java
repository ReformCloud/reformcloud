...
public interface Registry {
   ...
   * @return The object which should get inserted or the value which is already
   *     inserted
   */
  @Nonnull<T> T createKey(@Nonnull String keyName, @Nonnull T t);
   ...
   */
  @Nullable<T> T getKey(@Nonnull String keyName);
   ...
   */
  @Nullable<T> T updateKey(@Nonnull String key, @Nonnull T newValue);
