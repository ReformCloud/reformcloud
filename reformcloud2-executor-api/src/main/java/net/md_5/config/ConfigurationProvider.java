...
public abstract class ConfigurationProvider {
  ...
  static { providers.put(YamlConfiguration.class, new YamlConfiguration()); }

  public static ConfigurationProvider
  getProvider(Class<? extends ConfigurationProvider> provider) {
  ...
  public abstract Configuration load(File file, Configuration defaults)
      throws IOException;
