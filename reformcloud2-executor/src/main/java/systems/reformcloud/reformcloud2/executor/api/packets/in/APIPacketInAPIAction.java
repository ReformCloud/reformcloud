...
public final class APIPacketInAPIAction implements NetworkHandler {
  ...
  public void handlePacket(PacketSender packetSender, Packet packet,
    ...
    case PLAY_SOUND: {
      executor.executePlaySound(targetPlayer, packet.content().getString("2"),
    ...
    case SEND_MESSAGE: {
      executor.executeSendMessage(targetPlayer,
                                  packet.content().getString("2"));
      break;
    }

    case LOCATION_TELEPORT: {
      executor.executeTeleport(targetPlayer, packet.content().getString("2"),
    ...
    case SET_RESOURCE_PACK: {
      executor.executeSetResourcePack(targetPlayer,
                                      packet.content().getString("2"));
      break;
    }
    }
