...
public class CommandCloudPerms implements Command {
  ...
  public void execute(CommandSource commandSender, @NonNull String[] strings) {
    if (strings.length == 4 && strings[0].equalsIgnoreCase("user") &&
      ...
      if (uniqueID == null) {
        commandSender.sendMessage(
            TextComponent.of("§cThe uniqueID is unknown"));
        return;
      }
      ...
      if (group == null) {
        commandSender.sendMessage(
            TextComponent.of("§cThe group " + strings[3] + " does not exists"));
        return;
      }
      ...
      commandSender.sendMessage(
          TextComponent.of("§aSuccessfully §7added user " + strings[1] +
                           " to group " + strings[3]));
      return;
    }
    ...
    if (strings.length == 6 && strings[0].equalsIgnoreCase("user") &&
      ...
      if (givenTimeOut == null) {
        commandSender.sendMessage(
            TextComponent.of("§cThe timout time is not valid"));
        return;
      }
    ...
    if (strings.length == 4 && strings[0].equalsIgnoreCase("user") &&
      ...
      PermissionAPI.getInstance().getPermissionUtil().updateUser(user);
      commandSender.sendMessage(
          TextComponent.of("§aSuccessfully §7removed group " + strings[3] +
                           " from user " + strings[1]));
      return;
    }
    ...
    if (strings.length == 4 && strings[0].equalsIgnoreCase("user") &&
      ...
      if (!perm.isPresent()) {
        commandSender.sendMessage(
            TextComponent.of("§cThe permission " + strings[3] + " is not set"));
        return;
      }
    ...
    if (strings.length == 5 && strings[0].equalsIgnoreCase("group") &&
      ...
      if (group == null) {
        commandSender.sendMessage(
            TextComponent.of("§cThe group " + strings[1] + " does not exists"));
        return;
      }
      ...
      if (Links
              ...
              .isPresent()) {
        commandSender.sendMessage(
            TextComponent.of("§cThe permission " + strings[3] +
      ...
      commandSender.sendMessage(
          TextComponent.of("§7The permission " + strings[3] +
    ...
    commandSender.sendMessage(
        TextComponent.of("§7/perms user [user] addperm [permission] [set]"));
    commandSender.sendMessage(TextComponent.of(
        "§7/perms user [user] addperm [permission] [set] [timeout] [s/m/h/d/mo]"));
    commandSender.sendMessage(
        TextComponent.of("§7/perms user [user] delperm [permission]"));
    commandSender.sendMessage(
        TextComponent.of("§7/perms user [user] addgroup [group]"));
    commandSender.sendMessage(TextComponent.of(
        "§7/perms user [user] addgroup [group] [timeout] [s/m/h/d/mo]"));
    commandSender.sendMessage(
        TextComponent.of("§7/perms user [user] delgroup [group]"));
    commandSender.sendMessage(TextComponent.of(
        "§7/perms group [groupname] addperm [permission] [set]"));
    commandSender.sendMessage(TextComponent.of(
        "§7/perms group [groupname] addperm [permission] [set] [timeout] [s/m/h/d/mo]"));
    commandSender.sendMessage(
        TextComponent.of("§7/perms group [groupname] delperm [permission]"));
  }
  ...
  private static UUID getUniqueIDFromName(String name) {
    Optional<Player> player =
        VelocityPermissionPlugin.getProxy().getPlayer(name);
    return player.isPresent() ? player.get().getUniqueId()
