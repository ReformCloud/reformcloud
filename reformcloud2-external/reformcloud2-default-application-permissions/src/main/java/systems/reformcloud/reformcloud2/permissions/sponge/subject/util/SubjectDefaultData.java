...
public class SubjectDefaultData {
  ...
  private SubjectDefaultData() { throw new UnsupportedOperationException(); }

  private static final UUID DEFAULT_UUID =
      UUID.fromString("a038e8a0-d294-45a5-86f0-bf44d316beec");

  public static final Subject DEFAULT =
      new SpongeSubject(DEFAULT_UUID, CollectionCatalog.USER_COLLECTION,
