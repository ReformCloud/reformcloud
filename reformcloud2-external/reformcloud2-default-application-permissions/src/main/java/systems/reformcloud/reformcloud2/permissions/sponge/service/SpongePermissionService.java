...
public class SpongePermissionService implements PermissionService {
  ...
  public static final Map<String, PermissionDescription> DESCRIPTIONS =
      new ConcurrentHashMap<>();

  // ======

  static {
    LOADED.put(SUBJECTS_COMMAND_BLOCK,
               CollectionCatalog.COMMAND_BLOCK_COLLECTION);
  ...
  public static SpongePermissionService getInstance() { return instance; }

  // ======

  public SpongePermissionService() { instance = this; }
  ...
  @Override
  @Nonnull
  public CompletableFuture<SubjectCollection>
  loadCollection(@Nonnull String identifier) {
    return CompletableFuture.completedFuture(
        LOADED.getOrDefault(identifier, CollectionCatalog.FACTORY_COLLECTION));
  }
  ...
  public CompletableFuture<Boolean> hasCollection(@Nonnull String identifier) {
    return CompletableFuture.completedFuture(
        getCollection(identifier).isPresent());
  }
  ...
  newSubjectReference(@Nonnull String collectionIdentifier,
                      @Nonnull String subjectIdentifier) {
    return new SpongeSubjectReference(this, collectionIdentifier,
                                      subjectIdentifier);
  }

  @Override
  @Nonnull
  public PermissionDescription.Builder
  newDescriptionBuilder(@Nonnull Object plugin) {
    return new SpongePermissionDescriptionBuilder(
        this, Sponge.getPluginManager().fromInstance(plugin).orElse(null));
  }

  @Override
  @Nonnull
  public Optional<PermissionDescription>
  getDescription(@Nonnull String permission) {
  ...
  @Override
  public void
  registerContextCalculator(@Nullable ContextCalculator<Subject> calculator) {}
}
