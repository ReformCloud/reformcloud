...
public class CommandPerms extends GlobalCommand {
  ...
  public CommandPerms() {
    super("perms", "reformcloud.command.perms", "The main perms command",
          Arrays.asList("permissions", "cloudperms"));
  }
  ...
  public boolean handleCommand(@Nonnull CommandSource commandSource,
    ...
    if (strings.length == 3 && strings[0].equalsIgnoreCase("user") &&
    ...
    if (strings.length == 3 && strings[0].equalsIgnoreCase("user") &&
      ...
      System.out.println("Cleared all groups and permissions of user " +
                         strings[1]);
      return true;
    }
    ...
    if (strings.length == 5 && strings[0].equalsIgnoreCase("user") &&
      ...
      if (set == null) {
        System.out.println(
            "The permission may not be set correctly. Please recheck (use true/false as set argument)");
        return true;
      }
      ...
      PermissionAPI.getInstance().getPermissionUtil().updateUser(user);
      System.out.println("The permission " + strings[3] +
                         " was added to the user " + strings[1] +
                         " with value " + set);
      return true;
    }
    ...
    if (strings.length == 4 && strings[0].equalsIgnoreCase("user") &&
      ...
      PermissionAPI.getInstance().getPermissionUtil().updateUser(user);
      System.out.println("Removed permission " + strings[3] + " from user " +
                         strings[1]);
      return true;
    }
    ...
    if (strings.length == 4 && strings[0].equalsIgnoreCase("user") &&
      ...
      if (Links
              ...
              .isPresent()) {
        System.out.println("The user " + strings[1] + " is already in group " +
                           strings[3]);
        return true;
      }
      ...
      PermissionAPI.getInstance().getPermissionUtil().updateUser(user);
      System.out.println("Successfully added user " + strings[1] +
                         " to group " + strings[3]);
      return true;
    }
    ...
    if (strings.length == 4 && strings[0].equalsIgnoreCase("user") &&
      ...
      if (filter == null) {
        System.out.println("The user " + strings[1] + " is not in group " +
                           strings[3]);
        return true;
      }
      ...
      PermissionAPI.getInstance().getPermissionUtil().updateUser(user);
      System.out.println("Successfully removed group " + strings[3] +
                         " from user " + strings[1]);
      return true;
    }
    ...
    if (strings.length == 3 && strings[0].equalsIgnoreCase("group") &&
      ...
      System.out.println("The group " + strings[1] +
                         " was created successfully");
      return true;
    }

    if (strings.length == 4 && strings[0].equalsIgnoreCase("group") &&
        strings[2].equalsIgnoreCase("create")) {
      PermissionGroup group =
          PermissionAPI.getInstance().getPermissionUtil().getGroup(strings[1]);
      if (group != null) {
      ...
      PermissionGroup created =
          PermissionAPI.getInstance().getPermissionUtil().createGroup(
              strings[1]);
      if (defaultGroup) {
        PermissionAPI.getInstance().getPermissionUtil().addDefaultGroup(
            created.getName());
      }
    ...
    if (strings.length == 3 && strings[0].equalsIgnoreCase("group") &&
      ...
      System.out.println(
          "Successfully deleted all permissions and process-group-permissions from group " +
          strings[1]);
      return true;
    }
    ...
    if (strings.length == 4 && strings[0].equalsIgnoreCase("group") &&
      ...
      System.out.println("The group " + group.getName() + " is now a " +
                         (defaultGroup ? "default" : "normal") + " group");
      return true;
    }
    ...
    if (strings.length == 4 && strings[0].equalsIgnoreCase("group") &&
      ...
      System.out.println("The group " + group.getName() +
                         " has now the priority: " + priority);
      return true;
    }
    ...
    if (strings.length == 5 && strings[0].equalsIgnoreCase("group") &&
      ...
      if (Links
              ...
              .isPresent()) {
        System.out.println("The permission " + strings[3] +
                           " is already set for group " + strings[3]);
        return true;
      }
    ...
    if (strings.length == 6 && strings[0].equalsIgnoreCase("group") &&
        strings[2].equalsIgnoreCase("addperm")) {
      PermissionGroup group =
          PermissionAPI.getInstance().getPermissionUtil().getGroup(strings[1]);
      if (group == null) {
      ...
      if (group.getPerGroupPermissions().containsKey(strings[3]) &&
          Links
              .filterToReference(
                  group.getPerGroupPermissions().get(strings[3]),
                  e -> e.getActualPermission().equalsIgnoreCase(strings[3]))
              .isPresent()) {
        System.out.println("The permission " + strings[4] +
                           " is already set for group " + strings[2] + " on " +
                           strings[3]);
        return true;
      }
      ...
      PermissionAPI.getInstance().getPermissionUtil().addProcessGroupPermission(
          strings[3], group,
          new PermissionNode(System.currentTimeMillis(), -1, set, strings[4]));
      System.out.println("The permission " + strings[4] +
                         " was added to group " + group.getName() + " on " +
                         strings[3]);
      return true;
    }

    if (strings.length == 8 && strings[0].equalsIgnoreCase("group") &&
        strings[2].equalsIgnoreCase("addperm")) {
      PermissionGroup group =
          PermissionAPI.getInstance().getPermissionUtil().getGroup(strings[1]);
      if (group == null) {
      ...
      long timeOut = System.currentTimeMillis() +
                     InternalTimeUnit.convert(parseUnitFromString(strings[7]),
                                              givenTimeOut);
      PermissionAPI.getInstance().getPermissionUtil().addProcessGroupPermission(
          strings[3], group,
          new PermissionNode(System.currentTimeMillis(), timeOut, set,
                             strings[4]));
      System.out.println("The permission " + strings[4] +
                         " was added to group " + group.getName() + " on " +
                         strings[3]);
    ...
    if (strings.length == 4 && strings[0].equalsIgnoreCase("group") &&
      ...
      PermissionNode filter = Links.filter(
          group.getPermissionNodes(),
          e -> e.getActualPermission().equalsIgnoreCase(strings[3]));
      if (filter == null) {
        System.out.println("The permission " + strings[3] + " is not set");
    ...
    if (strings.length == 5 && strings[0].equalsIgnoreCase("group") &&
      ...
      if (!group.getPerGroupPermissions().containsKey(strings[3])) {
        System.out.println("There are no server group permission for group " +
                           group.getName() + " on " + strings[3]);
        return true;
      }
      ...
      if (filter == null) {
        System.out.println("The permission " + strings[4] + " is not set for " +
                           group.getName() + " on " + strings[3]);
        return true;
      }
      ...
      PermissionAPI.getInstance().getPermissionUtil().updateGroup(group);
      System.out.println("The permission " + strings[4] +
                         " was removed for group " + group.getName() + " on " +
                         strings[3]);
      return true;
    }
    ...
    if (strings.length == 5 && strings[0].equalsIgnoreCase("group") &&
      ...
      if (group.getSubGroups().contains(strings[4])) {
        System.out.println("The group " + strings[4] +
                           " is already a parent of " + group.getName());
        return true;
      }

      PermissionGroup sub =
          PermissionAPI.getInstance().getPermissionUtil().getGroup(strings[4]);
      if (sub == null) {
      ...
      PermissionAPI.getInstance().getPermissionUtil().updateGroup(group);
      System.out.println("The sub group " + sub.getName() + " was added to " +
                         group.getName());
      return true;
    }
    ...
    if (strings.length == 5 && strings[0].equalsIgnoreCase("group") &&
      ...
      if (!group.getSubGroups().contains(strings[4])) {
        System.out.println("The group " + strings[4] + " is not a parent of " +
                           group.getName());
        return true;
      }
      ...
      PermissionAPI.getInstance().getPermissionUtil().updateGroup(group);
      System.out.println("Removed sub group " + strings[4] + " from " +
                         group.getName());
      return true;
    }
