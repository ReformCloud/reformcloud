...
public class SignLayout implements Serializable, Cloneable {
  ...
  public SignLayout(@Nonnull LayoutContext context, @Nullable String target,
  ...
  public LayoutContext getContext() { return context; }

  public String getTarget() { return target; }

  public boolean isSearchingLayoutWhenFull() { return searchingLayoutWhenFull; }

  public boolean isShowMaintenanceProcessesOnSigns() {
    return showMaintenanceProcessesOnSigns;
  }

  public List<SignSubLayout> getSearchingLayouts() { return searchingLayouts; }

  public List<SignSubLayout> getWaitingForConnectLayout() {
    return waitingForConnectLayout;
  }

  public List<SignSubLayout> getEmptyLayout() { return emptyLayout; }

  public List<SignSubLayout> getOnlineLayout() { return onlineLayout; }

  public List<SignSubLayout> getFullLayout() { return fullLayout; }
